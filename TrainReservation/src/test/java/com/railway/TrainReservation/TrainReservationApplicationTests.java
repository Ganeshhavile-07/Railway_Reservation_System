...
class TrainReservationApplicationTests {
	...
	public void getTrainTest() {
		when(reservationRepository.findAll())
				.thenReturn(Stream
						.of(new Reservation("1", "sachin", "F", 22, "BY PASS", 123456, "ABI", "HIGH", 4, "NGP", "PUNE", null, 0),
	...
	public void deleteUserTest() {
		Reservation reservation = new Reservation("1", "sachin", "F", 22, "BY PASS", 123456, "ABI", "HIGH", 4, "NGP", "PUNE", null, 0);
